...
function SafeEmail({ email }: { email?: string }) {
  if (!email) {
    return (
      <span className="text-[var(--muted-foreground)]">Email unavailable</span>
    );
  }
...
function SafePhone({ phone }: { phone?: string }) {
  if (!phone) {
    return (
      <span className="text-[var(--muted-foreground)]">Phone unavailable</span>
    );
  }
      ...
      <div className="container mx-auto max-w-6xl px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-[var(--muted-foreground)] max-w-2xl mx-auto">
            Get in touch with Enwiya Law Firm for your legal advice,
            consultations, or any inquiries. Fill out the form below, and our
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-[var(--muted-foreground)]">
                We&apos;re here to help with all your legal needs. Reach out
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                <svg
                  className="w-6 h-6 text-[var(--headder-text-color)]"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-[var(--muted-foreground)]">
                  {displayOffices[0]?.office_address}
                </span>
              </div>
              <div className="flex items-center space-x-3">
                <svg
                ...
                <span className="text-[var(--muted-foreground)]">
                  {displayOffices[0]?.mailing_address}
                </span>
              </div>
            </div>
          </div>
