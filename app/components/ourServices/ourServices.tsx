      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <Link
            ...
            className="block group focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--primary-accent)] rounded-xl"
          >
            <div className="relative h-full bg-gradient-to-br from-[var(--headder-text-color)]/30 via-[var(--primary-accent)]/10 to-transparent border border-[var(--headder-text-color)] rounded-xl shadow-xl p-8 flex flex-col items-start transition-transform duration-200 group-hover:scale-105 group-hover:shadow-2xl group-hover:border-[var(--primary-accent)]">
              ...
              <h3 className="text-2xl font-bold text-[var(--text-headers-black)] mb-2">
                Corporate Law
              </h3>
              <p className="text-[var(--muted-foreground)] mb-4 leading-relaxed">
                Strategic counsel for entrepreneurs and companies, including
                entity formation, contracts, acquisitions, and succession
                planning.
              </p>
              <span className="mt-auto text-[var(--headder-text-color)] font-semibold group-hover:underline group-hover:text-[var(--primary-accent)] transition-colors">
                Learn more &rarr;
              </span>
              <span className="absolute right-6 top-6 opacity-10 text-7xl pointer-events-none select-none">
                <FaGavel className="text-[var(--headder-text-color)]" />
              </span>
            </div>
          </Link>
          <Link
          ...
          >
            <div className="relative h-full bg-gradient-to-br from-[var(--headder-text-color)]/30 via-[var(--primary-accent)]/10 to-transparent border border-[var(--headder-text-color)] rounded-xl shadow-xl p-8 flex flex-col items-start transition-transform duration-200 group-hover:scale-105 group-hover:shadow-2xl group-hover:border-[var(--primary-accent)]">
              ...
              <p className="text-[var(--muted-foreground)] mb-4 leading-relaxed">
                Personalized estate plans, wills, trusts, and asset protection
                to secure your legacy and provide peace of mind for your family.
              </p>
              <span className="mt-auto text-[var(--headder-text-color)] font-semibold group-hover:underline group-hover:text-[var(--primary-accent)] transition-colors">
                Learn more &rarr;
              </span>
              <span className="absolute right-6 top-6 opacity-10 text-7xl pointer-events-none select-none">
                <FaRegFileAlt className="text-[var(--headder-text-color)]" />
              </span>
            </div>
          </Link>
          <Link
          ...
          >
            <div className="relative h-full bg-gradient-to-br from-[var(--headder-text-color)]/30 via-[var(--primary-accent)]/10 to-transparent border border-[var(--headder-text-color)] rounded-xl shadow-xl p-8 flex flex-col items-start transition-transform duration-200 group-hover:scale-105 group-hover:shadow-2xl group-hover:border-[var(--primary-accent)]">
              ...
              <p className="text-[var(--muted-foreground)] mb-4 leading-relaxed">
                Guidance through probate and trust administration, asset
                management, and resolution of estate matters with care and
                clarity.
              </p>
              <span className="mt-auto text-[var(--headder-text-color)] font-semibold group-hover:underline group-hover:text-[var(--primary-accent)] transition-colors">
                Learn more &rarr;
              ...
              <span className="absolute right-6 top-6 opacity-10 text-7xl pointer-events-none select-none">
                <FaBalanceScale className="text-[var(--headder-text-color)]" />
              </span>
            </div>
          </Link>
          <Link
          ...
          >
            <div className="relative h-full bg-gradient-to-br from-[var(--headder-text-color)]/30 via-[var(--primary-accent)]/10 to-transparent border border-[var(--headder-text-color)] rounded-xl shadow-xl p-8 flex flex-col items-start transition-transform duration-200 group-hover:scale-105 group-hover:shadow-2xl group-hover:border-[var(--primary-accent)]">
              ...
              <p className="text-[var(--muted-foreground)] mb-4 leading-relaxed">
                Comprehensive immigration services, including family petitions,
                status adjustments, citizenship, and legal advising.
              </p>
              <span className="mt-auto text-[var(--headder-text-color)] font-semibold group-hover:underline group-hover:text-[var(--primary-accent)] transition-colors">
                Learn more &rarr;
              </span>
              <span className="absolute right-6 top-6 opacity-10 text-7xl pointer-events-none select-none">
                <FaGlobeAmericas className="text-[var(--headder-text-color)]" />
              </span>
            </div>
          </Link>
        </div>
