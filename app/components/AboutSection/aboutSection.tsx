...
const CAROUSEL_SLIDES = [
  {
    id: 1,
    src: "https://sfo.cloud.appwrite.io/v1/storage/buckets/69893cf90023d6e6e6a6/files/69f52f82002688bd7c7a/view?project=69880e000034360e8e76&mode=admin",
    alt: "Enwiya Law Firm office",
  },
  {
    id: 2,
    src: "https://sfo.cloud.appwrite.io/v1/storage/buckets/69893cf90023d6e6e6a6/files/69f52f8200268dc511ea/view?project=69880e000034360e8e76&mode=admin",
    alt: "Consultation room",
  },
  {
    id: 3,
    src: "https://sfo.cloud.appwrite.io/v1/storage/buckets/69893cf90023d6e6e6a6/files/69f52f8200268508c93a/view?project=69880e000034360e8e76&mode=admin",
    alt: "David Andrew Enwiya, Attorney",
  },
];
...
function AboutSection() {
  ...
  return (
    <section className="relative overflow-hidden select-none min-h-[440px] md:min-h-[560px]">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(to right, transparent 0%, rgba(11,11,11,0.55) 40%, rgba(11,11,11,0.92) 70%)",
        }}
      />

      {/* ── Text content (right side) ────────────────────────────── */}
      <div className="relative z-30 flex mr-[30px] items-center justify-end min-h-[440px] md:min-h-[560px] px-6 py-20">
        <div className="w-full max-w-md">
          ...
          <p className="text-[var(--navbar-font-color)]/75 text-lg leading-relaxed mb-5">
            Enwiya Law Firm was founded on the principle that legal services
            should be dependable and tailored to the circumstances of each
            client. Each matter is approached with careful attention to detail
            and thoughtful commitment to the client&apos;s objectives.
          </p>
