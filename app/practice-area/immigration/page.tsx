...
const Immigration = () => {
    return (
        <main className="min-h-screen bg-gradient-to-br from-black via-yellow-900/5 to-black text-white py-12 px-4">
            <div className="max-w-3xl mx-auto">
                <div className="relative bg-gradient-to-br from-yellow-400/40 via-yellow-900/10 to-transparent border border-yellow-400 rounded-2xl shadow-2xl p-10 overflow-hidden">
                    <div className="flex items-center gap-4 mb-6">
                        <span className="text-5xl md:text-6xl text-yellow-300 drop-shadow"><FaGlobeAmericas className="text-4xl text-yellow-400 drop-shadow" /></span>
                        <h1 className="text-3xl md:text-4xl font-extrabold text-yellow-400 tracking-tight drop-shadow">Immigration Law</h1>
                    </div>
                    <hr className="border-yellow-400/30 mb-6" />
                    ...
                    <div className="my-8">
                        <h2 className="text-2xl font-semibold text-yellow-300 mb-4">Our Immigration Services</h2>
                        <ul className="list-none space-y-3">
                            <li className="flex items-center gap-3"><FaDashcube className="text-yellow-400 text-lg" />Fiancé (K-1) Petitions</li>
                            <li className="flex items-center gap-3"><FaDashcube className="text-yellow-400 text-lg" />Spousal and Family-Based Petitions</li>
                            <li className="flex items-center gap-3"><FaDashcube className="text-yellow-400 text-lg" />Adjustment of Status</li>
                            <li className="flex items-center gap-3"><FaDashcube className="text-yellow-400 text-lg" />Removal of Conditions on Permanent Residence</li>
                            <li className="flex items-center gap-3"><FaDashcube className="text-yellow-400 text-lg" />Naturalization and U.S. Citizenship</li>
                            <li className="flex items-center gap-3"><FaDashcube className="text-yellow-400 text-lg" />Permanent Resident Card (Green Card) Renewals</li>
                            <li className="flex items-center gap-3"><FaDashcube className="text-yellow-400 text-lg" />USCIS Interview Preparation and Legal Advising</li>
                        </ul>
                    </div>
